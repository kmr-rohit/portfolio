# X — The harness is the product

Everyone ships the same models.
...
1/ Demo works. Production: ~60%. The misses are rarely “the model is dumb” — they’re harness failures.

2/ The model occupies one box. The harness is every other box, plus every arrow.
