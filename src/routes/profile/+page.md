...
<Seo
	title="Profile"
	description="Application brief — experience, AI projects, achievements, skills, and stock answers for custom hiring questions."
/>

<article class="profile-brief mdsvex">

<p class="profile-note">
	Application brief for custom hiring questions. Same content as
	<code>PROFILE.md</code> in the repo — copy from either place.
</p>
